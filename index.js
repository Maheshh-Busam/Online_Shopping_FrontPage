...
function renderProducts(product){
    ...
    imageElement.src = product.preview
    ...
    var brandNameElement = document.createElement("h5")
    brandNameElement.className ="product-brand"
    brandNameElement.innerText = product.brand
    var priceElement = document.createElement("p")
    priceElement.className = "product-price"
    priceElement.innerText = "Rs." + product.price
    productInfo.appendChild(productNameElement)
    productInfo.appendChild(brandNameElement)
